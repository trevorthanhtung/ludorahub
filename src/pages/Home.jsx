...
const MOCK_GAMES = [
  { id: 'true-or-dare', title: 'True or Dare', players: '+5', time: '∞', tag: 'HOT', categories: ['party', 'small-group', 'pass-and-play'], image: '/tod-banner.webp', externalUrl: '/GAMES/TRUE OR DARE/index.html' },
